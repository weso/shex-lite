...
import es.weso.shexlc.ast.expr.ConstraintNodeIRIExpr
 ...
 */
class ConstraintNodeIRIExprPsr(ctx: Shexl2Parser.Constraint_node_iri_exprContext, visitor: Syn01ASTBuilderStage)
