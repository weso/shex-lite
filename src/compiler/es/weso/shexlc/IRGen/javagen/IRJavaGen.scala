...
//--------------------------------------------------------------------------------------------------
//
// This file has been generated through the framework of the HERCULES-ASIO
// project.
// For more information please see https://github
// .com/weso/shex-lite/issues/0121.
//
//--------------------------------------------------------------------------------------------------
/**
  * The intermediate representation of the java code are the different domain
  * model objects generated from the
  * shapes.
  *
