//------------------------------------------------------------------------------
// File: ParseConstraintNodeAnyTypeExpr.scala
//
...
/**
  * The constraint node any type expression sub-parser generates a constraint
  * node of any type expression from the
  ...
  */
class ParseConstraintNodeAnyTypeExpr(
