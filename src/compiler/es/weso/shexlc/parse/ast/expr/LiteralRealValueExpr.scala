//--------------------------------------------------------------------------------------------------
// File: LiteralRealValueExpr.scala
//
 ...
 */
class LiteralRealValueExpr(line: Int, column: Int, interval: Interval, content: String, val value: Double) extends LiteralExpr with ConstraintValidValueSetExpr {
