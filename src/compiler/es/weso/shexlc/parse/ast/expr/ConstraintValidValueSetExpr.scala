...
/**
  * A base class for all the valid value set expressions of the es.weso
  * .shexlc.parse.ast.
  *
  * This expression trait is just used as a mean to know if an expression is
  * a valid value set, any. For
  * that it overrides the super is and as methods but let other literal is's
