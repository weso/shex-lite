...
/**
  * The compilation configuration is a basic configuration that is passed to
  * through the compilation context to all the
  * different tasks that take place and are the individual tasks who decide
