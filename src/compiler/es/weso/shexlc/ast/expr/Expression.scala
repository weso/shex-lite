 ...
 *
 * When an expression is added to the es.weso.shexlc.ast it is mandatory to add its is and as methods, that way it is much
 * simple and faster to check if the es.weso.shexlc.ast is semantically correct or not and also to access fields.
 *
 * @author Guillermo Facundo Colunga
 */
trait Expression extends NodeWithPosition {
