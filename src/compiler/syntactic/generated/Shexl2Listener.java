...
public interface Shexl2Listener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterConstraint_valid_value_set_type(Shexl2Parser.Constraint_valid_value_set_typeContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterConstraint_node_non_literal_expr(Shexl2Parser.Constraint_node_non_literal_exprContext ctx);
	/**
	 * Exit a parse tree produced by {@link Shexl2Parser#constraint_node_non_literal_expr}.
	 * @param ctx the parse tree
	 */
	void exitConstraint_node_non_literal_expr(Shexl2Parser.Constraint_node_non_literal_exprContext ctx);
	/**
